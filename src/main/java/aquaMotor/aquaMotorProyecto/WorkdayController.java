...
public class WorkdayController implements Initializable, InitializableWithUser {
        ...
        if (this.currentUser != null) {
            if (appBarController != null) {
                ...
                appBarController.setOnBackAction(() -> {
                    Node source = rootPane != null ? rootPane : tasksContainer;
                    ActionEvent fakeEvent = new ActionEvent(source, null);
    ...
    private void loadTasks() {
        ...
        for (Repairment r : list) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/aquaMotor/sales/mechanic/components/ListCard.fxml"));
